    ...
    <div>
      ...
      <div className="mt-1.5 flex flex-col gap-2 sm:flex-row">
        <input
          ...
          className="min-w-0 flex-1 rounded-[12px] border border-[var(--ink-faint)] bg-white px-3 py-2.5 text-sm placeholder:text-[var(--ink)]/30 focus:border-[var(--gold)] focus:outline-none focus:ring-2 focus:ring-[var(--gold-faint)]"
        />
        <label
