    ...
    <div className="grid gap-8 lg:grid-cols-2">
      ...
      <div className="rounded-[16px] border border-[var(--ink-faint)] bg-[var(--paper)] p-5">
        ...
        <p className="text-xs leading-relaxed text-[var(--ink)]/50">
          Crie acessos de <strong>Administração</strong> (acesso total) ou <strong>Gestor</strong> (só solicitações). E-mail será normalizado em minúsculas.
        </p>
        <form onSubmit={handleCreate} className="mt-4 space-y-3">
          ...
          <div>
            ...
            >
              ...
              <option value="COMISSAO">Gestor — só solicitações</option>
            </select>
            <p className="mt-1.5 text-[11px] leading-relaxed text-[var(--ink)]/40">
              Gestor só acessa a aba Solicitações (mesma regra da comissão). Administração gerencia tudo, inclusive usuários.
            </p>
          </div>
              ...
              <li key={u.id} className="rounded-[12px] border border-[var(--ink-faint)] bg-white px-4 py-3 shadow-sm">
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-xs text-[var(--ink)]/60">{u.email}</p>
                  ...
                  <div className="flex shrink-0 gap-1.5">
                    ...
                    <button
                      ...
                      className="rounded-full border border-red-200 bg-red-50 px-3 py-1 text-xs font-semibold text-red-700 hover:bg-red-100 disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                      Remover
                    </button>
                  </div>
      ...
      {editAlvo && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-[18px] border border-[var(--ink-faint)] bg-white p-6 shadow-strong">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm">
          <div className="w-full max-w-sm rounded-[18px] border border-[var(--ink-faint)] bg-white p-6 shadow-strong">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--ink-soft)]">
              ...
              <span className="rounded-full bg-[var(--ink)] px-2 py-0.5 text-xs font-bold text-white">{removerAlvo.email}</span>{" "}
